...
Version  : 1.1.107
Release  : 6
URL      : https://github.com/KhronosGroup/Vulkan-ValidationLayers/archive/v1.1.107/Vulkan-ValidationLayers-1.1.107.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-ValidationLayers/archive/v1.1.107/Vulkan-ValidationLayers-1.1.107.tar.gz
...
%prep
%setup -q -n Vulkan-ValidationLayers-1.1.107
...
export LANG=C
export SOURCE_DATE_EPOCH=1558106085
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
