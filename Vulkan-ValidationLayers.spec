...
Version  : 1.2.172
Release  : 18
URL      : https://github.com/KhronosGroup/Vulkan-ValidationLayers/archive/v1.2.172/Vulkan-ValidationLayers-1.2.172.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-ValidationLayers/archive/v1.2.172/Vulkan-ValidationLayers-1.2.172.tar.gz
...
%prep
%setup -q -n Vulkan-ValidationLayers-1.2.172
cd %{_builddir}/Vulkan-ValidationLayers-1.2.172
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615502886
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-ValidationLayers-1.2.172/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-ValidationLayers/9bf8124f4495a48c4fd7104aebe2e957176b930b
pushd clr-build
%make_install
popd
