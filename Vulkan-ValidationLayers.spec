...
Source0  : https://github.com/KhronosGroup/Vulkan-ValidationLayers/archive/v1.1.112/Vulkan-ValidationLayers-1.1.112.tar.gz
...
%prep
%setup -q -n Vulkan-ValidationLayers-1.1.112
...
export LANG=C
export SOURCE_DATE_EPOCH=1562037517
mkdir -p clr-build
pushd clr-build
