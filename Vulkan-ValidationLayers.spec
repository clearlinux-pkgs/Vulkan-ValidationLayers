...
Version  : 1.1.108
Release  : 7
URL      : https://github.com/KhronosGroup/Vulkan-ValidationLayers/archive/v1.1.108/Vulkan-ValidationLayers-1.1.108.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-ValidationLayers/archive/v1.1.108/Vulkan-ValidationLayers-1.1.108.tar.gz
...
%prep
%setup -q -n Vulkan-ValidationLayers-1.1.108
...
export LANG=C
export SOURCE_DATE_EPOCH=1559895390
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
%files dev
%defattr(-,root,root,-)
/usr/include/vulkan/cast_utils.h
